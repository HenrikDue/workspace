...
CREATE view [dbo].[vw_Delta_Brutto_old_150323] 
...
Select 'DELTA_BRUTTO' as Dim_Aendring, b.Dim_Fabrik, b.Materiale, b.Dim_Materiale, 'AUB' as LNType, b.LNType as FLNType, b.FraTil_tid
...
Left join dbo.vw_LogNedsBrutto a on b.Dim_Fabrik = a.Dim_Fabrik and b.Materiale = a.Materiale and b.FraTil_Tid = a.FraTil_Tid
