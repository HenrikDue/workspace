...
CREATE view [dbo].[vw_kassation_old_141125]
...
Case When kas.Maengde < 0	
	...
	Else 0
	End as NedForPrinC,
Case When lp.Beholdning > 0 and lp.NedskrNetto < 0
	 Then case When lp.Beholdning > kas.Maengde * -1	
			   Then	(kas.Maengde * -1) * (lp.NedskrNetto * -1) / lp.Beholdning
			   Else	lp.NedskrNetto * -1
			   End
	 Else 0
	 End NedskrNetto,
Case When kas.Maengde < 0 
