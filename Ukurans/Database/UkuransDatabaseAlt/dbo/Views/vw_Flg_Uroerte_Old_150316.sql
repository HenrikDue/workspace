...
CREATE view [dbo].[vw_Flg_Uroerte_Old_150316] 
-- Oprettet 150220-1: Flag for hvilke materialer, der i FraTil-perioden er fuldstændig urørte
-- Ajourført 150311-1: Ændret kritie til at være fra BogfDato >= til BogfDato >
as
...
From
	(Select  distinct a.FraTil_Tid, q1.Materiale, max(isnull(q1.BogfDato,0)) as SidsteTransDato , count(*) as Antal
	From edw.FT_Forklaring a
	Left join (	Select distinct a.Materiale, a.FraTil_Tid, b.BogfDato
				From edw.FT_Forklaring a
	...
	Group by a.FraTil_Tid, q1.Materiale, q1.BogfDato
	--With rollup
	--Order by q1.Materiale, a.FraTil_Tid, max(isnull(q1.BogfDato,0))
) q2
