...
CREATE view [dbo].[vw_Flg_Indk12md_old_150316] 
...
From
	(Select  distinct a.FraTil_Tid, q1.Materiale, max(isnull(q1.BogfDato,0)) as SidsteTransDato, q1.BevArtType, count(*) as Antal
	From edw.FT_Forklaring a
	Left join (	Select distinct a.Materiale, a.FraTil_Tid, b.BogfDato, c.BevArtType
				From edw.FT_Forklaring a
...
--				Where c.BevArtType = 'Indkøb'
	...
	Group by a.FraTil_Tid, q1.Materiale, q1.BogfDato, q1.BevArtType
	--With rollup
