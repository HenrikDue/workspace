...
CREATE VIEW [dbo].[vw_NedskrivNetto_old_150803]
...
From (
		...
		full outer join dbo.vw_ManuelVurdering_2_Test b on lnb.Dim_Fabrik = b.Dim_Fabrik and lnb.Dim_Materiale = b.Dim_Materiale
	) q1
