...
CREATE view [dbo].[vw_Faldende_Beh_old_141125]
						 ...
						 Then Case When isnull(cy.Beholdning, 0) = 0	
								   ...
								   Else Case When kas.AnskVaerdi is null
											Then	(((isnull(ly.Vaerdi_GP, 0) * -1)/isnull(ly.Beholdning, 0))*(isnull(ly.Beholdning, 0) - isnull(cy.Beholdning, 0)))
											 Else	((isnull(ly.Vaerdi_GP, 0) * -1)/isnull(ly.Beholdning, 0))*(isnull(ly.Beholdning, 0)-isnull(cy.Beholdning, 0) - isnull( - kas.Beholdning, 0)) 
											End
								   End
						 Else	0
						 End
			   ...
			   Then Case When isnull(ly.Beholdning, 0) > isnull(cy.Beholdning, 0)	
						 Then Case When isnull(cy.Beholdning, 0) = 0	
								   ...
								   Else Case When kas.AnskVaerdi is null
											 ...
											 Else ((isnull(ly.LogNedBrutto, 0) * -1) /isnull(ly.Beholdning, 0))*(isnull(ly.Beholdning, 0)-isnull(cy.Beholdning, 0) - isnull( - kas.Beholdning, 0))
											 End
								   End
						  Else	0
						  End
						 ...
						 Then Case When	isnull(cy.Beholdning, 0) =	0	
								   ...
								   Else Case When kas.AnskVaerdi is null
											Then	(((isnull(ly.NedskrNetto, 0) * -1)/isnull(ly.Beholdning, 0))*(isnull(ly.Beholdning, 0) - isnull(cy.Beholdning, 0)))
											 Else	((isnull(ly.NedskrNetto, 0) * -1)/isnull(ly.Beholdning, 0))*(isnull(ly.Beholdning, 0)-isnull(cy.Beholdning, 0) - isnull( - kas.Beholdning, 0))
											End
								   End
						 Else	0
						 End
						  ...
						  Then Case When isnull(cy.Beholdning, 0) =	0	
								   ...
								   Else Case When kas.AnskVaerdi is null
											Then	(((isnull(ly.Vaerdi_SP, 0) * -1)/isnull(ly.Beholdning, 0))*(isnull(ly.Beholdning, 0) - isnull(cy.Beholdning, 0)))
											 Else	((isnull(ly.Vaerdi_SP, 0) * -1)/isnull(ly.Beholdning, 0))*(isnull(ly.Beholdning, 0)-isnull(cy.Beholdning, 0) - isnull( - kas.Beholdning, 0))
												End
								   End
   						  Else	0
						  End
