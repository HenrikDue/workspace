...
CREATE view [dbo].[vw_NedskrSfaRID_Efter_Indk] -- OK
-- Oprettet 150818-1: Kalkuler nedskrivningsprocent som følge af lang rækkevidde efter indkøb
as
...
,ftm.MinRID_Efter_Indk															-- Andet feltnavn
,ftm.Forbr_pr_dag																-- Andet feltnavn
,Case	when ftm.MinRID_Efter_Indk > 365										-- Andet feltnavn
		then Power(dlh.RID_NedskrFaktor,ftm.MinRID_Efter_Indk)-1				-- Andet feltnavn
		else 0 
