...
CREATE view [dbo].[vw_Nedskriv_Primo_Brutto_old_141125]
...
From
	...
	,sum(Beholdning) as Beholdning, sum(Vaerdi_GP) as AnskVaerdi, sum(LogNedBrutto) as NedForPrinc
	,sum(LogNedBrutto) as NedskrNetto, sum(Vaerdi_SP) as Vaerdi_SP
