...
CREATE view [dbo].[vw_Nedskriv_Pae_old_150225_(Foer_Where_Indsat_IC4)] 
as
-- Ajourført 150113-1: FLNType sker nu efterfølgende ved brug af procedure
-- Ajourført 150120-1: Midlertidigt indsat kriterie for at der ikke korrigeres ved IC4, denne linie er indsat 3 steder
--					   Ved kørsler der rækker længere tilbage end Dim_Tid 201411, skal linierne elimineres
select 
