...
CREATE view [dbo].[vw_Delta_Netto_old_150323] 
...
Select 'DELTA_NETTO' as Dim_Aendring, b.Dim_Fabrik, b.Materiale, b.Dim_Materiale, b.LNType,  b.FLNType, b.FraTil_tid
,isnull(a.AnskVaerdi, 0)	- isnull(b.AnskVaerdi, 0) as AnskVaerdi
,isnull(a.NedForPrinc, 0)	- isnull(b.NedForPrinc, 0) as NedForPrinc
	,Case	When	isnull(a.NedskrNetto, 0) <> 0 
			Then	Case	When	isnull(a.NedForPrinc, 0)	<>	0 
...
Left join dbo.vw_NedskrivNetto a on a.Dim_Fabrik = b.Dim_Fabrik and a.Materiale = b.Materiale and a.FraTil_Tid = b.FraTil_Tid
