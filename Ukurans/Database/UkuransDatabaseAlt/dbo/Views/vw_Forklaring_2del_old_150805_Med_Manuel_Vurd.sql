...
Create view [dbo].[vw_Forklaring_2del_old_150805_Med_Manuel_Vurd]
...
--insert into edw.FT_Forklaring
select 'KASS_BEH' Aendring, Dim_Fabrik, Materiale, Dim_Materiale, null LNType,  null FLNType, FraTil_tid, AnskVaerdi, NedForPrinc
	,Case	When	NedskrNetto <> 0 
			Then	Case	When	NedForPrinc	<>	0 
							Then	NedskrNetto	-	NedForPrinc
							Else	NedskrNetto
...
Dim_Fabrik, Materiale, Dim_Materiale, LNType, FLNType, FraTil_tid, AnskVaerdi, NedForPrinc, DSystAnedr, NedskrNetto, Beholdning, Vaerdi_SP, Forskel
from [dbo].[vw_ManuelVurdering_2]