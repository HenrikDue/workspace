CREATE TABLE [edw].[Dim_Litra_BU_150701_1_Efter_P06] (
    ...
    CONSTRAINT [PK_Dim_Litra_PK_ID_BU_150701_1_Efter_P06] PRIMARY KEY CLUSTERED ([PK_ID] ASC) WITH (FILLFACTOR = 75, PAD_INDEX = ON)
);
