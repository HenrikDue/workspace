CREATE TABLE [dbo].[ABC_G_SDL_Activities] (
    ...
    CONSTRAINT [PK_ABC_G_SDL_Activities] PRIMARY KEY CLUSTERED ([SourceReference] ASC, [SourceModuleType] ASC, [Periode] ASC) WITH (FILLFACTOR = 90, DATA_COMPRESSION = PAGE)
);
