CREATE TABLE [dbo].[ABC_G_ATT_Funktionskunde] (
    ...
    CONSTRAINT [PK_ABC_Attribute_Funktionskunde] PRIMARY KEY CLUSTERED ([AttributeDimension] ASC, [AccountModuleType] ASC, [AccountReference] ASC, [Periode] ASC) WITH (FILLFACTOR = 90, DATA_COMPRESSION = PAGE)
);
