CREATE TABLE [dbo].[ABC_G_ATTHIER_ProdVar] (
    ...
    CONSTRAINT [PK_ABC_AttibHierarchy_ProduktVariabilitet] PRIMARY KEY CLUSTERED ([AttributeReference] ASC, [AttributeDimension] ASC, [Periode] ASC) WITH (FILLFACTOR = 90, DATA_COMPRESSION = PAGE)
);
