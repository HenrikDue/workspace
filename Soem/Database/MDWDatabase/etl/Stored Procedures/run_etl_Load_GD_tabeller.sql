...
-- =============================================
CREATE PROCEDURE [etl].[run_etl_Load_GD_tabeller]
AS
BEGIN
...
truncate table etl.ssisdb_messages
 ...
 ,@project_name = '100-ETL_Load_GD_tabeller'
 ,@package_name = '001_KOER_ALLE_PAKKER_ETL_Load_GD_tabeller.dtsx'
 ,@reference_id=NULL
...
select
 Pakkenavn = '001_KOER_ALLE_PAKKER_ETL_Load_GD_tabeller',
