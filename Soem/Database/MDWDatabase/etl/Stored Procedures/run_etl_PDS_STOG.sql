...
-- =============================================
CREATE PROCEDURE [etl].[run_etl_PDS_STOG]
AS
BEGIN
...
truncate table etl.ssisdb_messages
 ...
 ,@project_name = '070-ETL_PDS_STOG'
 ,@package_name = '001_KOER_ALLE_PAKKER_ETL_PDS_STOG.dtsx'
 ,@reference_id=NULL
...
select
 Pakkenavn = '001_KOER_ALLE_PAKKER_ETL_PDS_STOG',
