...
-- =============================================
CREATE PROCEDURE [etl].[run_etl_Togpersonale_FR_PDS]
AS
BEGIN
...
set @databasename = db_name();
 ...
 ,@project_name = '020-ETL_PDS'
 ,@package_name = '001_KOER_ALLE_PAKKER_ETL_PDS.dtsx'
 ,@reference_id=NULL
...
select
 Pakkenavn = '001_KOER_ALLE_PAKKER_ETL_PDS',
