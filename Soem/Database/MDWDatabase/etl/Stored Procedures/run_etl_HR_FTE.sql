...
-- =============================================
CREATE PROCEDURE [etl].[run_etl_HR_FTE]
AS
BEGIN
...
truncate table etl.ssisdb_messages
 ...
 ,@project_name = '040-ETL_HR_FTE'
 ,@package_name = '001_KOER_ALLE_PAKKER_ETL_HR_FTE.dtsx'
 ,@reference_id=NULL
...
select
 Pakkenavn = '001_KOER_ALLE_PAKKER_ETL_HR_FTE',
