...
-- =============================================
CREATE PROCEDURE [etl].[run_etl_2000_Koer_straekningsoekonomi_del_2]
AS
BEGIN
...
truncate table etl.ssisdb_message

exec [SSISDB].catalog.create_execution 
  @folder_name = @databasename
 ,@project_name = 'ETL_Strækningsøkonomi'
 ,@package_name = '2000_Koer_straekningsoekonomi_del_2.dtsx'
 ,@reference_id=NULL
...
select
 Pakkenavn = '2000_Koer_straekningsoekonomi_del_2',
