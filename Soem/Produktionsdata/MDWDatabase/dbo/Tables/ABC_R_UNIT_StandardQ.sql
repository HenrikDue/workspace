CREATE TABLE [dbo].[ABC_R_UNIT_StandardQ] (
    ...
    CONSTRAINT [PK_ABC_P_UNIT_StandardQ] PRIMARY KEY CLUSTERED ([AccountReference] ASC, [AccountModuleType] ASC, [UnitLabel] ASC) WITH (FILLFACTOR = 90, DATA_COMPRESSION = PAGE)
);
